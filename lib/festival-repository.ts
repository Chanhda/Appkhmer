...
function mapFestivalDoc(id: string, data: Record<string, unknown>): FestivalItem {
  ...
  return {
    ...
    rituals: (data.rituals as FestivalItem['rituals']) || defaultItem.rituals,
    foods: (data.foods as FestivalItem['foods']) || defaultItem.foods,
    highlights: (data.highlights as FestivalItem['highlights']) || defaultItem.highlights,
