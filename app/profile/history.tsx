...
export default function HistoryScreen() {
  ...
  const clearHistory = () => {
    Alert.alert('Xóa lịch sử', 'Bạn có muốn xóa toàn bộ lịch sử hoạt động?', [
      { text: 'Hủy', style: 'cancel' },
      { text: 'Xóa toàn bộ', style: 'destructive', onPress: () => setHistory([]) },
    ]);
  };
      ...
      >
        <View style={styles.headerContent}>
          <View style={styles.headerTextBox}>
            ...
            <ThemedText style={styles.headerSub}>{history.length} hoạt động gần đây</ThemedText>
          </View>
          <Pressable
      ...
      >
        {history.length === 0 ? (
          <Animated.View entering={FadeInDown.duration(600)} style={styles.emptyContainer}>
            ...
            <ThemedText style={styles.emptyTitle}>Chưa có lịch sử</ThemedText>
                  ...
                  >
                    ...
                    <View style={styles.itemContent}>
                      ...
                      <View style={styles.itemMeta}>
                        <ThemedText style={[styles.itemAction, { color: item.iconColor }]}>{item.action}</ThemedText>
