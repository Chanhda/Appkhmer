      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <Animated.View entering={FadeInDown.duration(600)} style={styles.heroWrap}>
          ...
          <View style={styles.heroContent}>
            ...
            <Text style={styles.heroTitle}>{heroFestival.title[lang]}</Text>
            <Text style={styles.heroDateDisplay}>📅 {heroFestival.dateDisplay[lang]}</Text>
            ...
            <Animated.View key={item.id} entering={FadeInUp.delay(index * 100).duration(400)}>
              ...
              >
                ...
                <View style={styles.cardInfo}>
                  ...
                  <Text style={[styles.cardTitle, { color: C.text }]}>{item.title[lang]}</Text>
                  <Text style={[styles.cardSubtitle, { color: C.textSecondary }]} numberOfLines={2}>{item.subtitle[lang]}</Text>

                  <View style={styles.cardFooter}>
                    <View style={styles.locTag}>
                      <IconSymbol name="mappin" size={14} color="#D4AF37" />
                      <Text style={styles.locText} numberOfLines={1}>{item.location[lang]}</Text>
                    </View>
                    <Pressable
                      style={[
            ...
            {selectedFestival && (
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.modalBody}>
                  ...
                  <Text style={[styles.modalTitle, { color: C.text }]}>{selectedFestival.title[lang]}</Text>
                  <Text style={styles.modalLocation}>📍 {selectedFestival.location[lang]}</Text>

                  <View style={styles.divider} />

                  <Text style={styles.sectionHeading}>{uiTexts.ritualHeader}</Text>
                  <Text style={[styles.modalDesc, { color: C.textSecondary }]}>
                    {selectedFestival.description[lang]}
                  </Text>

                  <Text style={styles.sectionHeading}>{uiTexts.stepsHeader}</Text>
                  {selectedFestival.rituals[lang].map((r, i) => (
                  ...
                  <View style={styles.tagWrap}>
                    {selectedFestival.foods[lang].map((f, i) => (
